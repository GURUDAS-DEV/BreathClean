  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        {/* Animated leaf logo spinner */}
        <div className="relative flex items-center justify-center">
          {/* Pulsing glow ring */}
          <div className="absolute h-16 w-16 animate-ping rounded-full bg-[#2bee6c]/20" />

          {/* Spinning ring */}
          <div className="h-14 w-14 animate-spin rounded-full border-[3px] border-slate-200 border-t-[#2bee6c] dark:border-slate-700 dark:border-t-[#2bee6c]" />
